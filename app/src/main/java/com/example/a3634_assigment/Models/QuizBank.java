        ...
        switch (category) {
            ...
            case "Earth":
                ...
                case "Jupiter":
                    ...
                    options.add(jupiterQ1 = new Options("Which planet from the Sun is Jupiter?", "6th", "5th", "4th", "1st", 2));  //3rd
                    options.add(jupiterQ2 = new Options("How bright is Jupiter on average compared to other natural objects from Earth?","3rd brightest", "Brightest", "2nd brightest", "5th brightst", 1)); //71%
                    options.add(jupiterQ3 = new Options("What is Jupiter primarily composed of?","Hydrogen & Helium", "Carbon", "Oxygen", "Helium & Iron", 1));//99%
                    options.add(jupiterQ4 = new Options("What shape does Jupiter have?","Oblate spheroid", "Obscure spheroid", "Acute spheroid", "Inflated spheroid", 1));//365days
                    options.add(jupiterQ5 = new Options("What is the giant storm on Jupiter that can be viewed by telescope called?","Giant Red Spot", "Giant Blue Spot", "Giant Red Region", "Giant Orange Region", 1)); //solid iron
                    options.add(jupiterQ6 = new Options("How many moons does Jupiter have?", "79 moons", "57 moons", "24 moons", "17 moons", 1)); //
                    options.add(jupiterQ7 = new Options("Which moon of Jupiter do scientists believe could potentially habour life?", "Europa", "Oblivion", "Oportus-3", "Graviton", 1)); //4.1billion years ago
                    options.add(jupiterQ8 = new Options("What type of giant is Jupiter?", "Gas giant", "Solid giant", "Liquid giant", "Solid & Liquid giant", 1)); //most dense
                    break;
                ...
                case "Venus":
                    ...
                    options.add(venusQ1 = new Options("Which planet from the Sun is Venus?","6th", "3rd", "2nd", "1st", 3));  //3rd
                    options.add(venusQ2 = new Options("What is Venus' atmosphere consisted of?","96% carbon dioxide", "59% oxygen", "85% helium", "63% hydrogen", 1)); //71%
                    options.add(venusQ3 = new Options("Venus is shrouded by an opaque layer of what?", "Clouds of carbon dioxide", "Clouds of sulphuric acid", "Clouds of hydrogen", "Clouds of helium", 2));//99%
                    options.add(venusQ4 = new Options("How long does it take Venus to orbit the Sun?","243 days", "398 days", "47 days", "365 days", 1));//365days
                    options.add(venusQ5 = new Options("Venus is:" , "the coldest planet in our Solar System at 23K", "the coldest planet in our Solar System at 0K", "the hottest planet in our Solar System at 735K", "the hottest planet in our Solar System at 1000K", 3)); //solid iron
                    ...
                    options.add(venusQ7 = new Options("How many moons does Venus have?","0", "4", "6", "2", 1)); //4.1billion years ago
                    options.add(venusQ8 = new Options("Is Venus visible from Earth to the visible eye?", "Yes, you can even sometimes see it in daylight", "No, it is too far away to be visible", "Yes, but only at night", "No, it's too small to be seen", 1)); //most dense
                    break;
                ...
                case "Pluto":
                    ...
                    options.add(plutoQ1 = new Options("Which planet from the Sun is Pluto?","6th", "3rd", "9th", "1st", 3));  //3rd
                    options.add(plutoQ2 = new Options("Where is Pluto situated?","Kuiper belt", "Orion belt", "Maximus belt", "Jupital belt", 1)); //71%
                    options.add(plutoQ3 = new Options("What is Pluto primarily made up of?", "Ice & rock", "Rock & water", "Gas & rock", "Gas & water", 1));//99%
                    options.add(plutoQ4 = new Options("How long does light from the Sun take to reach Pluto?","5 hours", "4.5 hours", "6.5 hours", "5.5 hours", 4));//365days
                    options.add(plutoQ5 = new Options("How many moons does Pluto have?", "5", "8", "2", "0", 1)); //solid iron
                    ...
                    options.add(plutoQ7 = new Options("What spacecraft performed a fly-by of Pluto in 2015?","New Horizons", "New Orbits", "Pro Horizons", "Martian Explorer", 1)); //4.1billion years ago
                    options.add(plutoQ8 = new Options("What is the name of Pluto's largest moon?","Hammer", "Charon", "Kapers", "Orion", 2)); //most dense
                    break;
